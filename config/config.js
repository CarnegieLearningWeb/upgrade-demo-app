...
module.exports = {
    ...
    UPGRADE_API_URL: process.env.UPGRADE_API_URL || "",
    ...
    EXTERNAL_APP_SESSION_SECRET: process.env.EXTERNAL_APP_SESSION_SECRET || process.env.PAT_SESSION_SECRET || "",
    PAT_SESSION_SECRET: process.env.PAT_SESSION_SECRET || ""
};
